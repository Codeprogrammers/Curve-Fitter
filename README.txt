...
# Codeprogrammers.net
#
# This iOS App is free to use and modify as you see fit. But please,
...
#The COREPLOT-LICENSE applies to all files in CorePlot-Framework and all other
#code that is not specifically in mentioned in LICENSE.
#
# DISCLAIMER: 
